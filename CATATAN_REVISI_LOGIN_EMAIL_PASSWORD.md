...
## Cara Membuat Akun Validator

1. Login sebagai admin.
2. Buka menu **Daftar Pengguna**.
3. Buka bagian **Tambah Akun Email & Password untuk Validasi**.
4. Isi nama, email, password, role, status aktif, dan keterangan.
5. Klik **Buat Akun**.
6. Akun validator dapat langsung login dari halaman utama menggunakan email dan password tersebut.
...
- Untuk validasi media, role yang disarankan adalah `siswa` jika validator ingin melihat tampilan siswa, atau `guru` jika validator ingin melihat dashboard guru.
